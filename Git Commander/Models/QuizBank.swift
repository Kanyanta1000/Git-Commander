...
struct QuizBank {
    var quizes: [Quiz] = [
        ...
        Quiz(title: "Undoing Changes", icon: nil, questions: [
        ...
        Quiz(title: "Rewriting Git History", icon: nil, questions: [
        ...
        Quiz(title: "Git Branches", icon: nil, questions: [
        ...
        Quiz(title: "Remote Repositories", icon: nil, questions: [
